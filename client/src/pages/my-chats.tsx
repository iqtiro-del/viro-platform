                ...
                >
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      {/* Avatar */}
                      <Avatar className="w-14 h-14 ring-2 ring-primary/30" data-testid={`avatar-${otherUser.id}`}>
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-2 mb-2">
                          <div className="flex-1 min-w-0">
                            <h3 className="text-lg font-semibold text-foreground mb-1" data-testid={`text-username-${chat.id}`}>
                              {otherUser.username}
                          ...
                          {/* Status Badge */}
                          <Badge 
                            className={`${statusInfo.color} flex items-center gap-1.5 px-3 py-1 neon-glow-primary whitespace-nowrap`}
                        ...
                        {/* Product Info */}
                        <div className="flex items-center gap-2 p-3 rounded-lg bg-background/50 border border-border/30 mt-3">
                          <Package className="w-4 h-4 text-primary flex-shrink-0" />
                          <div className="flex-1 min-w-0">
                            <p className="text-sm font-medium text-foreground truncate" data-testid={`text-product-${chat.id}`}>
                              {chat.product.title}
                            </p>
                        ...
                        {chat.paymentScheduledAt && (
                          <div className="flex items-center gap-2 mt-2 p-2 rounded bg-blue-500/10 border border-blue-400/30">
